...
name = 'new_roidb_file_attrac_nms0_5';
...
test_sub_folder_suffix = @(x) sprintf('attrac_nms0_5_F24_%d', x);
...
for i = 1:7
    ...
    if ~exist(new_roidb_file(i), 'file')
        ...
        if i == 1
            load_name = ['./functions/external_prop/attractioNet/boxes_nms_0.50.mat'];
        else
