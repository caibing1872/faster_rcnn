...
RPN_TEST_ilsvrc_hyli(cache_base_proposal, 'train14', 'final', ...
    model, dataset.imdb_train{2}, dataset.roidb_train{2}, conf_proposal, ...     
...
% fprintf('\nStage one proposal test on training data...\n');
% dataset.roidb_test = cellfun(@(x,y) RPN_TEST_ilsvrc_hyli(...
