...
model.stage1_rpn.nms.note = 'multiNMS_default_set';   % must be a string
...
model.stage1_rpn.max_per_image    = [2000, 1000,  400,  200,  100,   40,   20,   10];
% ==========================================================
...
dataset = RPN_TEST_ilsvrc_hyli(cache_base_proposal, 'train14', 'final', ...
    ...
    'max_per_image',        model.stage1_rpn.max_per_image, ...
