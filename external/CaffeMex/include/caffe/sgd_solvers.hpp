...
class SGDSolver : public Solver<Dtype> {
 ...
 protected:
  ...
  virtual void SnapshotSolverState(const string& model_filename, string snapshot_filename="");
  virtual void SnapshotSolverStateToBinaryProto(const string& model_filename, string snapshot_filename="");
  virtual void SnapshotSolverStateToHDF5(const string& model_filename, string snapshot_filename = "");
