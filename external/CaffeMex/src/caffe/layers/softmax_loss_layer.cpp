...
void SoftmaxWithLossLayer<Dtype>::Forward_cpu(
  ...
  //top[0]->mutable_cpu_data()[0] = loss / get_normalizer(normalization_, weights_sum);
...
void SoftmaxWithLossLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
  ...
  if (propagate_down[0]) {
    ...
    weights_sum == Dtype(0.0) ? Dtype(0.0) : (loss_weight / get_normalizer(normalization_, weights_sum));
    caffe_scal(prob_.count(), weights_sum, bottom_diff);
  }
}
