function model = VGG16_for_Faster_RCNN(solver_name)
% VGG 16layers (only finetuned from conv3_1)
% for ilsvrc dataset!

if nargin == 0
    solver_name = 'solver_60k80k';
end
...
% for train14+val1
%model.stage1_rpn.solver_def_file = fullfile(pwd, 'models', 'rpn_prototxts', 'vgg_16layers_conv3_1', 'solver_12w20w_ilsvrc.prototxt');
